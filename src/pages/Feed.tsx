...
const feedPosts = [
  ...
  },
  {
    ...
    caption: "Derrière les coulisses de ma dernière création. Photographe et storyteller passionnée 📸",
    likes: 5243,
    comments: 156,
    timeAgo: "4h",
    isPremium: true,
  ...
  },
  {
    ...
    caption: "Réglages de post-production pour cette ambiance cinématographique",
    likes: 1832,
    comments: 34,
    timeAgo: "6h",
  },
  {
    ...
    caption: "Collection XDose - Découvrez mes dernières créations visuelles",
    likes: 3621,
    comments: 98,
    timeAgo: "8h",
    isPremium: true,
